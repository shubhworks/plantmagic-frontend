...
export const Footer = () => {
  return (
    <footer className="bg-[#012e0c] text-primary-foreground">
      <div className="container-wide section-padding">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          {/* Popular Links */}
          <div>
            <h4 className="font-semibold text-lg mb-6 text-[#20ad4d]">Popular Links</h4>
          ...
          {/* Products */}
          <div>
            <h4 className="font-semibold text-lg mb-6 text-[#20ad4d]">Products</h4>
            <ul className="space-y-3">
          ...
          {/* Contact & Newsletter */}
          <div>
            <h4 className="font-semibold text-lg mb-6 text-[#20ad4d]">Contact Us</h4>
